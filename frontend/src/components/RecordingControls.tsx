          ...
          {isProcessing && !isParentProcessing ? (
            ...
            <>
              {showPlayback ? (
                ...
                <>
                  {!isRecording ? (
                    // Start recording button. The screen-recording mode toggle
                    // lives in the sidebar (and Settings → Preferences) so it
                    // stays visible regardless of which page you're on.
                    <Tooltip>
